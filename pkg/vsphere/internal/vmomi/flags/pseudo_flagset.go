...
func ContextWithPseudoFlagset(ctx context.Context, client *govmomi.Client, spec *api.VsphereProviderSpec1) context.Context {
...
func GetSpecFromPseudoFlagset(ctx context.Context) *api.VsphereProviderSpec1 {
	return ctx.Value(specPseudoFlagKey).(*api.VsphereProviderSpec1)
}
